...
#define timerPin 50  // Button for starting the timer
#define timerLEDPin 48 // Indicates that the timer is running
#define alarmClearPin 46  // Button to clear alarms
#define startPin 44  // Button to begin a process
#define stopPin 42  // Button to end a process
#define idlePin 40  // Toggle to enter idle mode
#define idleLED 38 // LED indicator for when the system is in idle mode
#define manualHeatPin 36  // Toggle to control the heating coil manually
#define manualHeatLED 34 // LED indicator for when the heating coil is being controlled manually
#define manualPumpPin 32 // Toggle to control the pump manually
#define manualPumpLED 30 // LED indicator for when the pump is being controlled manually
